...
public class UnitOfWorkDeleteRelationImpl implements UnitOfWorkDeleteRelation
{
  ...
  public <E> OpResult deleteRelation( String parentTable, Map<String, Object> parentObject, String columnName,
                                      List<E> children )
  {
    return relationOperation.relationOperation( OperationType.DELETE_RELATION, parentTable,
  ...
  {
    return relationOperation.relationOperation( OperationType.DELETE_RELATION, parentTable, parentObject,
  ...
  {
    return relationOperation.relationOperation( OperationType.DELETE_RELATION, parentObject, columnName, children );
  }
  ...
  {
    return relationOperation.relationOperation( OperationType.DELETE_RELATION, parentObject,
                                                columnName, whereClauseForChildren );
  }
