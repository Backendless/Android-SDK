...
public class UnitOfWorkSetRelationImpl implements UnitOfWorkSetRelation
{
  ...
  public <E> OpResult setToRelation( String parentTable, Map<String, Object> parentObject, String columnName,
                                     List<E> children )
  {
    return relationOperation.relationOperation( OperationType.SET_RELATION, parentTable, parentObject, columnName, children );
  }
  ...
  {
    return relationOperation.relationOperation( OperationType.SET_RELATION, parentTable,
  ...
  {
    return relationOperation.relationOperation( OperationType.SET_RELATION, parentTable, parentObject,
  ...
  {
    return relationOperation.relationOperation( OperationType.SET_RELATION, parentTable, parentObjectId,
                                                columnName, whereClauseForChildren);
  }
  ...
  {
    return relationOperation.relationOperation( OperationType.SET_RELATION, parentObject, columnName, children );
  }
  ...
  {
    return relationOperation.relationOperation( OperationType.SET_RELATION, parentObject, columnName, whereClauseForChildren );
  }
