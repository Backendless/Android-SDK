...
public class UnitOfWorkAddRelationImpl implements UnitOfWorkAddRelation
{
  ...
  public <E> OpResult addToRelation( String parentTable, Map<String, Object> parentObject, String columnName,
                                     List<E> children )
  {
    return relationOperation.relationOperation( OperationType.ADD_RELATION, parentTable,
  ...
  {
    return relationOperation.relationOperation( OperationType.ADD_RELATION, parentObject, columnName, children );
  }
  ...
  {
    return relationOperation.relationOperation( OperationType.ADD_RELATION, parentObject,
  ...
  public OpResult addToRelation( String parentTable, OpResult parentObject,
                                 String columnName, String whereClauseForChildren )
  {
    return relationOperation.relationOperation( OperationType.ADD_RELATION, parentTable, parentObject,
                                                columnName, whereClauseForChildren );
  }
  ...
  {
    return relationOperation.relationOperation( OperationType.ADD_RELATION, parentTable, parentObject, columnName, children );
  }
