...
public class ExceptionMessage
{
  ...
  public final static String OP_RESULT_INDEX_YES_PROP_NAME_NOT = "Cannot use OpResultValueReference which references a primitive value. It must point to a complete object.";
