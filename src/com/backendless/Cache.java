...
public class Cache
{
  ...
  public void put( String key, Object object, int timeToLive, AsyncCallback<Object> callback )
  {
    ...
    Invoker.invokeAsync( CACHE_SERVER_ALIAS, "putBytes", new Object[] { Backendless.getApplicationId(), key, bytes, timeToLive }, callback );
  }
  ...
  {
    byte[] bytes = serialize( object );
    Invoker.invokeSync( CACHE_SERVER_ALIAS, "putBytes", new Object[] { Backendless.getApplicationId(), key, bytes, timeToLive }, getChainedResponder() );
  }

  public <T> T get( String key, Class<? extends T> type )
  {
    byte[] bytes = Invoker.invokeSync( CACHE_SERVER_ALIAS, "getBytes", new Object[] { Backendless.getApplicationId(), key }, new AdaptingResponder<byte[]>( byte[].class, new PoJoAdaptingPolicy<byte[]>() ) );
  ...
  {
    return Invoker.invokeSync( CACHE_SERVER_ALIAS, "containsKey", new Object[] { Backendless.getApplicationId(), key }, getChainedResponder() );
  }

  public void contains( String key, AsyncCallback<Boolean> callback )
  {
    Invoker.invokeAsync( CACHE_SERVER_ALIAS, "containsKey", new Object[] { Backendless.getApplicationId(), key }, callback );
  }

  public void expireIn( String key, int seconds )
  {
    Invoker.invokeSync( CACHE_SERVER_ALIAS, "expireIn", new Object[] { Backendless.getApplicationId(), key, seconds }, getChainedResponder() );
  }

  public void expireIn( String key, int seconds, AsyncCallback<Object> callback )
  {
    Invoker.invokeAsync( CACHE_SERVER_ALIAS, "expireIn", new Object[] { Backendless.getApplicationId(), key, seconds }, callback );
  }
  ...
  {
    Invoker.invokeSync( CACHE_SERVER_ALIAS, "expireAt", new Object[] { Backendless.getApplicationId(), key, timestamp }, getChainedResponder() );
  }
  ...
  {
    Invoker.invokeAsync( CACHE_SERVER_ALIAS, "expireAt", new Object[] { Backendless.getApplicationId(), key, timestamp }, callback );
  }

  public void delete( String key )
  {
    Invoker.invokeSync( CACHE_SERVER_ALIAS, "delete", new Object[] { Backendless.getApplicationId(), key }, getChainedResponder() );
  }

  public void delete( final String key, final AsyncCallback<Object> callback )
  {
    Invoker.invokeAsync( CACHE_SERVER_ALIAS, "delete", new Object[] { Backendless.getApplicationId(), key }, callback );
  }
