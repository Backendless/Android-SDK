...
public final class Persistence
{
  ...
  public void mapTableToClass( String tableName, Class clazz )
 {
  ...
  protected <E> Long remove( final E entity ) throws BackendlessException
  {
    ...
    Object result;
    if( ResponderHelper.needsPhantomCache( entity.getClass() ) )
    {
    ...
    {
      result = Invoker.invokeSync( PERSISTENCE_MANAGER_SERVER_ALIAS, "remove", new Object[] { Backendless.getApplicationId(), Backendless.getVersion(), getSimpleName( entity.getClass() ), entity.getClass() } );
    }
  ...
  protected <E> E findById( final E entity, List<String> relations, int relationsDepth )
  {
    ...
    if( ResponderHelper.needsPhantomCache( entity.getClass() ) )
    {
      // find by id
      String objectId = FootprintsManager.getInstance().getObjectId( entity );
      return (E) Invoker.invokeSync( PERSISTENCE_MANAGER_SERVER_ALIAS, "findById", new Object[] { Backendless.getApplicationId(), Backendless.getVersion(), getSimpleName( entity.getClass() ), objectId, relations, relationsDepth }, ResponderHelper.getPOJOAdaptingResponder( entity.getClass() ) );
    }
    else
    {
