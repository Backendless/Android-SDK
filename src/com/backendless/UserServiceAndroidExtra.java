...
class UserServiceAndroidExtra
{
    ...
    GraphRequest request = GraphRequest.newMeRequest( accessToken, new GraphRequest.GraphJSONObjectCallback()
      {
                                 ...
                                 GraphResponse response )
        {
          ...
          Object[] requestData = new Object[] { Backendless.getApplicationId(), facebookBundle.socialUserId, facebookBundle.accessToken, facebookBundle.expirationDate, facebookBundle.permissions, facebookFieldsMappings };
  ...
  {
     Invoker.invokeAsync( UserService.USER_MANAGER_SERVER_ALIAS, "loginWithGooglePlus", new Object[] { Backendless.getApplicationId(), tokenId, accessToken, permissions, fieldsMappings }, new AsyncCallback<BackendlessUser>()
    {
      @Override
