...
public final class Counters
{
  ...
  {
    Invoker.invokeSync( ATOMIC_MANAGER_SERVER_ALIAS, "reset", new Object[] { Backendless.getApplicationId(), counterName } );
  }

  public void reset( String counterName, AsyncCallback callback )
  {
    Invoker.invokeAsync( ATOMIC_MANAGER_SERVER_ALIAS, "reset", new Object[] { Backendless.getApplicationId(), counterName }, callback );
  }
  ...
  public <T> void get( String counterName, AsyncCallback<T> responder )
  {
    try
    {
      Invoker.invokeAsync( ATOMIC_MANAGER_SERVER_ALIAS, "get", new Object[] { Backendless.getApplicationId(), counterName }, new AtomicCallback( responder ) );
    }
    catch( Throwable e )
    {
      if( responder != null )
  ...
  public <T> void getAndIncrement( String counterName, AsyncCallback<T> responder )
  {
    try
    {
      Invoker.invokeAsync( ATOMIC_MANAGER_SERVER_ALIAS, "getAndIncrement", new Object[] { Backendless.getApplicationId(), counterName }, new AtomicCallback( responder ) );
    }
    catch( Throwable e )
    {
      if( responder != null )
  ...
  public <T> void incrementAndGet( String counterName, AsyncCallback<T> responder )
  {
    try
    {
      Invoker.invokeAsync( ATOMIC_MANAGER_SERVER_ALIAS, "incrementAndGet", new Object[] { Backendless.getApplicationId(), counterName }, new AtomicCallback( responder ) );
    }
    catch( Throwable e )
    {
      if( responder != null )
  ...
  public <T> void getAndDecrement( String counterName, AsyncCallback<T> responder )
  {
    try
    {
      Invoker.invokeAsync( ATOMIC_MANAGER_SERVER_ALIAS, "getAndDecrement", new Object[] { Backendless.getApplicationId(), counterName }, new AtomicCallback( responder ) );
    }
    catch( Throwable e )
    {
      if( responder != null )
  ...
  public <T> void decrementAndGet( String counterName, AsyncCallback<T> responder )
  {
    try
    {
      Invoker.invokeAsync( ATOMIC_MANAGER_SERVER_ALIAS, "decrementAndGet", new Object[] { Backendless.getApplicationId(), counterName }, new AtomicCallback( responder ) );
    }
    catch( Throwable e )
    {
      if( responder != null )
  ...
  public <T> void addAndGet( String counterName, Number value, AsyncCallback<T> responder )
  {
    try
    {
      Invoker.invokeAsync( ATOMIC_MANAGER_SERVER_ALIAS, "addAndGet", new Object[] { Backendless.getApplicationId(), counterName, value }, new AtomicCallback( responder ) );
    }
    catch( Throwable e )
    {
      if( responder != null )
  ...
  public <T> void getAndAdd( String counterName, Number value, AsyncCallback<T> responder )
  {
    try
    {
      Invoker.invokeAsync( ATOMIC_MANAGER_SERVER_ALIAS, "getAndAdd", new Object[] { Backendless.getApplicationId(), counterName, value }, new AtomicCallback( responder ) );
    }
    catch( Throwable e )
    {
      if( responder != null )
  ...
  {
    return (Boolean) Invoker.invokeSync( ATOMIC_MANAGER_SERVER_ALIAS, "compareAndSet", new Object[] { Backendless.getApplicationId(), counterName, expected, updated } );
  }
  ...
  public void compareAndSet( String counterName, Number expected, Number updated, AsyncCallback<Boolean> responder )
  {
    try
    {
      Invoker.invokeAsync( ATOMIC_MANAGER_SERVER_ALIAS, "compareAndSet", new Object[] { Backendless.getApplicationId(), counterName, expected, updated }, responder );
    }
    catch( Throwable e )
    {
      if( responder != null )
  ...
  {
    Number responseValue = Invoker.invokeSync( ATOMIC_MANAGER_SERVER_ALIAS, operationName, new Object[] { Backendless.getApplicationId(), counterName } );
  ...
  {
    Number responseValue = Invoker.invokeSync( ATOMIC_MANAGER_SERVER_ALIAS, operationName, new Object[] { Backendless.getApplicationId(), counterName, value } );
    responseValue = convertToType( responseValue, Long.class );
    return (Long) responseValue;
  }
}
