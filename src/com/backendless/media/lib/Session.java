...
public class Session {
	...
	/** The phone may not support some backendless parameters that you are using (bit rate, frame rate...s). */
	...
	/**
	 * Creates a backendless session that can be customized by adding tracks.
	 */
	public Session() {
	...
	public interface Callback {
		 ...
		 * consumption of the streams when backendless.
		 */
	...
	public void syncConfigure()
			...
			InvalidSurfaceException, RuntimeException, IOException
  {
	...
	public void syncStart(int id)
			...
			StorageUnavailableException,
			ConfNotSupportedException,
			InvalidSurfaceException, UnknownHostException, IOException
  {
