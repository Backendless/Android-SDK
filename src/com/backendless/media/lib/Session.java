...
import com.backendless.media.lib.exceptions.StorageUnavailableException;
...
public class Session
{
  ...
  /**
   * The supplied BackendlessSurfaceView is not a valid surface, or has not been created yet.
   */
  ...
  static
  {
    ...
    new HandlerThread( "com.backendless.media.lib.backendless.Session" )
    {
      @Override
   ...
   */
  public void setSurfaceView( final BackendlessSurfaceView view )
  {
  ...
  public void syncStart(
          int id ) throws CameraInUseException, StorageUnavailableException, ConfNotSupportedException, InvalidSurfaceException, UnknownHostException, IOException
  {
   ...
   * You should of course pass a {@link com.backendless.media.lib.gl.BackendlessSurfaceView} to {@link #setSurfaceView(com.backendless.media.lib.gl.BackendlessSurfaceView)}
