...
import com.backendless.media.lib.rtp.AbstractPacketizer;
...
public abstract class MediaStream implements Stream {
	...
	public void setTimeToLive(int ttl) throws IOException
  {
	...
	/**
	 * Sets the backendless method that will be used.
	 *
	...
	/**
	 * Indicates if the {@link MediaStream} is backendless.
	 * @return A boolean indicating if the {@link MediaStream} is backendless
	 */
	 ...
	 * {@link VideoStream#setVideoQuality(com.backendless.media.lib.video.VideoQuality)}
	 * for a {@link VideoStream} and {@link AudioStream#setAudioQuality(com.backendless.media.lib.audio.AudioQuality)}
	 * for a {@link AudioStream}.
	 */
	public synchronized void configure() throws IllegalStateException, IOException
  {
		if (mStreaming) throw new IllegalStateException("Can't be called while backendless.");
		if (mPacketizer != null) {
	...
	protected void createSockets() throws IOException
  {
		...
		final String LOCAL_ADDR = "com.backendless.media.lib.backendless-";
