...
package com.backendless.media.lib.gl;
...
/**
 * An enhanced BackendlessSurfaceView in which the camera preview will be rendered.
 ...
 * <p/>
 * Second, it allows to force the aspect ratio of the BackendlessSurfaceView
 * to match the aspect ratio of the camera preview, so that the
 * preview do not appear distorted to the user of your app. To do
 * that, call {@link BackendlessSurfaceView#setAspectRatioMode(int)} with
 * {@link BackendlessSurfaceView#ASPECT_RATIO_PREVIEW} after creating your
 * {@link BackendlessSurfaceView}. <br />
 */
public class BackendlessSurfaceView extends android.view.SurfaceView implements Runnable, OnFrameAvailableListener,
                                                                                SurfaceHolder.Callback
{

  public final static String TAG = "BackendlessSurfaceView";
  ...
  public BackendlessSurfaceView( Context context, AttributeSet attrs )
  {
    super( context, attrs );
  ...
  public void startGLThread()
  {
    ...
    {
      mThread = new Thread( BackendlessSurfaceView.this );
      mRunning = true;
      mThread.start();
