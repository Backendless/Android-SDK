...
import com.backendless.media.lib.audio.AACStream;
import com.backendless.media.lib.audio.AMRNBStream;
import com.backendless.media.lib.audio.AudioQuality;
import com.backendless.media.lib.audio.AudioStream;
import com.backendless.media.lib.gl.BackendlessSurfaceView;
import com.backendless.media.lib.video.H263Stream;
import com.backendless.media.lib.video.H264Stream;
import com.backendless.media.lib.video.VideoQuality;
import com.backendless.media.lib.video.VideoStream;
...
public class SessionBuilder
{
  ...
  private BackendlessSurfaceView mBackendlessSurfaceView = null;
  ...
  public Session build()
  {
    ...
    if( session.getVideoTrack() != null )
    {
      ...
      video.setSurfaceView( mBackendlessSurfaceView );
  ...
  /**
   * Sets the BackendlessSurfaceView required to preview the video stream.
   */
  public SessionBuilder setSurfaceView( BackendlessSurfaceView backendlessSurfaceView )
  {
    mBackendlessSurfaceView = backendlessSurfaceView;
    return this;
  }
  ...
  /**
   * Returns the BackendlessSurfaceView set with {@link #setSurfaceView(com.backendless.media.lib.gl.BackendlessSurfaceView)}.
   */
  public BackendlessSurfaceView getSurfaceView()
  {
    return mBackendlessSurfaceView;
  }
  ...
  {
    return new SessionBuilder().setDestination( mDestination ).setOrigin( mOrigin ).setSurfaceView( mBackendlessSurfaceView ).setPreviewOrientation( mOrientation ).setVideoQuality( mVideoQuality ).setVideoEncoder( mVideoEncoder ).setFlashEnabled( mFlash ).setCamera( mCamera ).setTimeToLive( mTimeToLive ).setAudioEncoder( mAudioEncoder ).setAudioQuality( mAudioQuality ).setContext( mContext ).setCallback( mCallback );
  }
}