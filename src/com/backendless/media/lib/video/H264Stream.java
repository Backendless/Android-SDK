...
import com.backendless.media.lib.mp4.MP4Config;
import com.backendless.media.lib.rtp.H264Packetizer;
...
/**
 * A class for backendless H.264 from the camera of an android device using RTP.
...
public class H264Stream extends VideoStream {
	...
	public synchronized void configure() throws IllegalStateException, IOException
  {
	...
	/** 
	 * Tests if backendless with the given configuration (bit rate, frame rate, resolution) is possible
	...
	private MP4Config testMediaCodecAPI() throws RuntimeException, IOException
  {
		...
		try {
			...
			// Fallback on the old backendless method using the MediaRecorder API
