...
import com.backendless.media.lib.Stream;
import com.backendless.media.lib.exceptions.CameraInUseException;
import com.backendless.media.lib.exceptions.ConfNotSupportedException;
import com.backendless.media.lib.exceptions.InvalidSurfaceException;
import com.backendless.media.lib.gl.BackendlessSurfaceView;
import com.backendless.media.lib.hw.EncoderDebugger;
import com.backendless.media.lib.hw.NV21Convertor;
import com.backendless.media.lib.rtp.MediaCodecInputStream;
...
public abstract class VideoStream extends MediaStream
{
  ...
  protected BackendlessSurfaceView mBackendlessSurfaceView = null;
   ...
   */
  public synchronized void setSurfaceView( BackendlessSurfaceView view )
  {
    mBackendlessSurfaceView = view;
    if( mSurfaceHolderCallback != null && mBackendlessSurfaceView != null && mBackendlessSurfaceView.getHolder() != null )
    {
      mBackendlessSurfaceView.getHolder().removeCallback( mSurfaceHolderCallback );
    }
    if( mBackendlessSurfaceView.getHolder() != null )
    {
      ...
      mBackendlessSurfaceView.getHolder().addCallback( mSurfaceHolderCallback );
      mSurfaceReady = true;
    }
  }
  ...
  public synchronized void stop()
  {
    if( mCamera != null )
    {
      ...
      {
        ((BackendlessSurfaceView) mBackendlessSurfaceView).removeMediaCodecSurface();
      }
      super.stop();
  ...
  protected void encodeWithMediaRecorder() throws IOException
  {
    ...
    try
    {
      ...
      mMediaRecorder.setPreviewDisplay( mBackendlessSurfaceView.getHolder().getSurface() );
  ...
  protected void encodeWithMediaCodecMethod2() throws RuntimeException, IOException
  {
    ...
    ((BackendlessSurfaceView) mBackendlessSurfaceView).addMediaCodecSurface( surface );
    mMediaCodec.start();
  ...
  {
    if( mBackendlessSurfaceView == null )
      throw new InvalidSurfaceException( "Invalid surface !" );
    if( mBackendlessSurfaceView.getHolder() == null || !mSurfaceReady )
      throw new InvalidSurfaceException( "Invalid surface !" );
    ...
    if( mCamera == null )
    {
      ...
      try
      {
        ...
        try
        {
          if( mMode == MODE_MEDIACODEC_API_2 )
          {
            mBackendlessSurfaceView.startGLThread();
            mCamera.setPreviewTexture( mBackendlessSurfaceView.getSurfaceTexture() );
          }
          else
          {
            mCamera.setPreviewDisplay( mBackendlessSurfaceView.getHolder() );
          }
        }
        catch( IOException e )
        {
  ...
  protected synchronized void updateCamera() throws RuntimeException
  {
    ...
    mBackendlessSurfaceView.requestAspectRatio( ratio );
