...
2. **Locate Application ID and Secret Key.** The console is where you can manage the applications, their configuration settings and data. Before you start using any of the APIs, make sure to select an application in the console and open the â€œManageâ€ section. The â€œApp Settingsâ€ screen contains the application ID and secret API keys, which you will need to use in your code.
