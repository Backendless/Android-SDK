...
INSERT INTO `Version` (`main`, `application`) values (14, 52);
...
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('58', 'RENAME_DELETE_DIRECTORY');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('59', 'UPLOAD_CREATE_FILES');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('60', 'RENAME_DELETE_FILES');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('61', 'CHANGE_FILE_PERMISSIONS');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('62', 'ZIP_DIRECTORY');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('63', 'UNZIP_FILE');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('64', 'EDIT_FILE');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('65', 'MOVE_FILE');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('66', 'COPY_FILE');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('67', 'DELETE_FILE_PERMISSIONS');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('68', 'CREATE_MESSAGING_CHANNEL');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('69', 'RENAME_DELETE_MESSAGING_CHANNEL');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('70', 'SEND_MESSAGE_TO_CHANNEL');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('71', 'CHANGE_MESSAGING_CHANNEL_PERMISSIONS');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('72', 'CREATE_PUSH_TEMPLATE');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('73', 'CHANGE_DELETE_PUSH_TEMPLATE');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('74', 'CREATE_PUSH_BUTTON_OPTIONS');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('75', 'CHANGE_DELETE_PUSH_BUTTON_OPTIONS');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('76', 'CREATE_MESSAGING_CHANNEL_OPTIONS');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('77', 'CHANGE_DELETE_MESSAGING_CHANNEL_OPTIONS');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('78', 'SEND_PUSH_BY_TEMPLATE');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('79', 'DELETE_DEVICES');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('80', 'DELETE_MESSAGING_CHANNEL_PERMISSIONS');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('81', 'CREATE_GEO_CATEGORY');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('82', 'RENAME_DELETE_GEO_CATEGORY');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('83', 'SETUP_SAMPLE_GEO_DATA');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('84', 'CHANGE_GEO_CATEGORY_PERMISSIONS');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('85', 'MODIFY_GEO_POINT_METADATA');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('86', 'CREATE_GEOFENCE');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('87', 'MODIFY_DELETE_GEOFENCE');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('88', 'ADD_CATEGORY');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('89', 'REMOVE_GEO_POINTS');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('90', 'COPY_GEO_POINTS');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('91', 'REMOVE_ALL_GEO_POINTS');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('92', 'IMPORT_GEO_POINTS');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('93', 'DELETE_GEO_CATEGORY_PERMISSIONS');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('94', 'CREATE_API_SERVICE');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('95', 'DELETE_API_SERVICE');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('96', 'ADD_METHOD_CODELESS_JS_API_SERVICE');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('97', 'CHANGE_API_SERVICE_PERMISSIONS');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('98', 'CREATE_EVENT_HANDLER');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('99', 'CHANGE_DELETE_EVENT_HANDLER');

INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('100', 'CREATE_TIMER');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('101', 'CHANGE_TIMER');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('102', 'DELETE_TIMER');

INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('103', 'ADD_FILE_IN_CODING');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('104', 'DELETE_FILE_IN_CODING');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('105', 'CHANGE_DEPLOYMENT_MODEL_CHAIN');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('106', 'PUBLISH_TO_MARKETPLACE');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('107', 'CHANGE_IMPORTED_SERVICE');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('108', 'TEST_API_SERVICE_CONFIGURATION');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('109', 'CRATE_API_SERVICE_CONFIGURATION');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('110', 'CREATE_MARKETPLACE_CONFIGURATION');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('111', 'DELETE_API_SERVICE_PERMISSIONS');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('112', 'CREATE_CODE_FILES');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('113', 'DEPLOY_DRAFT');

INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('114', 'RUN_TIMER');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('115', 'INVOKE_EVENT_WITH_MODEL');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('116', 'DELETE_FROM_MARKETPLACE');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('117', 'ACTIVATE_DATACONNECTOR');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('118', 'CHANGE_DATACONNECTOR');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('119', 'DELETE_DATACONNECTOR');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('120', 'STORED_PROCEDURE');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('121', 'ADD_CHANGE_KEY');
INSERT INTO `DeveloperOperation` (`id`, `name`) VALUES ('122', 'DELETE_KEY');
...
CREATE TABLE IF NOT EXISTS `UserRegistrationSettings` (
  ...
  `registrationCallback` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'when set to true, user registration must be  also sent to registrationCallbackURL\n',
  `registrationCallbackURL` VARCHAR(256) NULL,
